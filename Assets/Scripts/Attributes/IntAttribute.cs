...
namespace Attributes
{
    ...
    public class IntAttribute : ScriptableObject, INotifyBindablePropertyChanged
    {
        ...
        private float GetPercentage(int maxValue) => (float)Value / maxValue;
        ...
        private bool IsAtLeast(int amount) => Value >= amount;
        ...
        private bool IsAtMost(int amount) => Value <= amount;
        ...
        private bool IsBetween(int min, int max) => Value >= min && Value <= max;
        ...
        private bool IsExactly(int amount) => Value == amount;
