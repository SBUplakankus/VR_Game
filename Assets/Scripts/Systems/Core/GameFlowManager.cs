...
namespace Systems.Core
{
    ...
    public class GameFlowManager : MonoBehaviour
    {
        ...
        private void HandleStartMenuEnter() => SystemEvents.SettingsLoadRequested.Raise();
        private void HandleStartMenuExit() => SystemEvents.SettingsSaveRequested.Raise();
        ...
        private void HandleHubEnter() => SystemEvents.PlayerLoadRequested.Raise();
        private void HandleHubExit() => SystemEvents.PlayerSaveRequested.Raise();
        ...
        private void HandleVictoryExit() => SystemEvents.PlayerSaveRequested.Raise();
        private void HandleDefeatEnter() => Debug.Log("GameFlowManager: Enter Defeat");
        private void HandleDefeatExit() => SystemEvents.PlayerSaveRequested.Raise();
        private void HandlePausedEnter() => Debug.Log("GameFlowManager: Enter Pause");
        private void HandlePausedExit() => Debug.Log("GameFlowManager: Exit Pause");
